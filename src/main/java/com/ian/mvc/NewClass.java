...
import com.ian.mvc.NewController;
...
class NewController_ {
    ...
    public String getMainWallRegistered(ModelMap model, String msisdn, String request) {
        ...
        try {
            ...
            this.setMenuItems(model, list, count, user.getLangCode().toLowerCase());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return INDEX;
    ...
    public String getHashTag(ModelMap model, String msisdn, String request) {
        ...
        if (!ussdSession.isAdvertServed() && !ussdSession.isSubscribed()) {
            return this.getAdvert(model, msisdn, request, "This sponsored message comes from a REST service.It must contain 132 characters,including white spaces.It appears per USSD session."
                    + "\n" + "Powered by Chomi USSD.", 301);
        }
    ...
    public void setMenuItems(ModelMap model, List<UssdMenu> list, int count, String language) {
        String menu = "";
        String x = "";
        for (UssdMenu m : list) {
    ...
    public String getWelcomeNote(ModelMap model, final String msisdn, String request) {
            ...
            try {
                ...
                if (cache.get(msisdn) == null) {
                    ...
                    if (reasonCode.equalsIgnoreCase("NO VALID PACKAGE") || reasonCode.contains("FAILED SUSPENDED")) {
                        ...
                        ussdSession.setSubscribed(true);//ussdSession.setSubscribed(false);
                        ussdSessionService.updateUssdSession(ussdSession);
        ...
        if (ussdSession.getMsisdn().equalsIgnoreCase("27716046757")) {//To avoid my number from being billed.
